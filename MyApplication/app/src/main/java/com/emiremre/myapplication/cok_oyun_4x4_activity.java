...
public class cok_oyun_4x4_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cok_oyun_4x4);
    ...
    public void onBackPressed() {
        Intent back_int = new Intent(cok_oyun_4x4_activity.this, oyuna_basla_activity.class);
        this.finish();
        ...
        for (int i = 1; i < 45; i++) {
            ...
            mReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    kartlar[id] = new kart(cok_oyun_4x4_activity.this, id, kart_puani, kart_adi, kart_evi, onresim_id);
                    kartlar_es[id] = new kart(cok_oyun_4x4_activity.this, id, kart_puani, kart_adi, kart_evi, onresim_id);
                }
    ...
    public void sinif_kart_ekle(kart[] sinif, kart[] sinif_es) {
        ...
        ekran_kartlari.add(sinif[array[0]]);
        ekran_kartlari.add(sinif[array[1]]);

        ekran_kartlari.add(sinif_es[array[0]]);
        ekran_kartlari.add(sinif_es[array[1]]);
    }
    ...
    public void oyunu_baslat(View v) throws IOException {
        ...
        sinif_kart_ekle(kartlar_gryffindor, kartlar_gryffindor_es);
        sinif_kart_ekle(kartlar_slytherin, kartlar_slytherin_es);
        sinif_kart_ekle(kartlar_ravenclaw, kartlar_ravenclaw_es);
        sinif_kart_ekle(kartlar_hufflepuff, kartlar_hufflepuff_es);

        //Ekran kartlarini karistirma
        Collections.shuffle(ekran_kartlari);
        gl.removeAllViews();
        for (kart temp : ekran_kartlari) {
            gl.addView(temp,250,350);
        }
                    ...
                    if( son_kart.kart_adi != "0")
                    {
                        ...
                        if(son_kart.kart_adi == ekran_kartlari.get(id).kart_adi) {
                            ...
                            if(son_kart.kart_evi.equals("Gryffindor") || son_kart.kart_evi.equals("Slytherin")) {
                                ...
                                if(sira_kimde % 2 == 0)
                                    oyuncu_1_puan = oyuncu_1_puan + ((2 * son_kart.kart_puani * 1));
                                else
                                    oyuncu_2_puan = oyuncu_2_puan + ((2 * son_kart.kart_puani * 1));
                            }
                            ...
                            h.postDelayed (new Runnable() {
                                ...
                                public void run() { //1 saniye bekle ve sifirlama islemlerini yap
                                    ...
                                    son_kart = new kart(cok_oyun_4x4_activity.this,0,0,"0","0","0"); //Son karti sifirla
                                }
                            ...
                            if(son_kart.kart_evi.equals(ekran_kartlari.get(id).kart_evi)) {
                                if(son_kart.kart_evi.equals("Gryffindor") || son_kart.kart_evi.equals("Slytherin")) {
                                    ...
                                    if(sira_kimde % 2 == 0)
                                        ...
                                        oyuncu_2_puan = oyuncu_2_puan - ((son_kart.kart_puani + ekran_kartlari.get(id).kart_puani)/1)*(gecen_sure/10);
                                }
                            }
                            ...
                            if(counter == 1) {
                                ...
                                h.postDelayed (new Runnable() {
                                    ...
                                    public void run() { //1 saniye bekle ve sifirlama islemlerini yap
                                        ...
                                        son_kart.cevir();
                                        ekran_kartlari.get(id).cevir();
                                        son_kart = new kart(cok_oyun_4x4_activity.this,0,0,"0","0","0");
        ...
        new CountDownTimer(60500, 1000) {
            ...
            public void onTick(long l) {
                ...
                if(kart_bulundu == 8) {
                    ...
                    Intent intnt = new Intent(cok_oyun_4x4_activity.this, kazan_activity.class);
                    oyuncu_1_puan = Float.parseFloat(TV_puan_oyuncu_1.getText().toString().substring(17));
                    oyuncu_2_puan = Float.parseFloat(TV_puan_oyuncu_2.getText().toString().substring(17));
