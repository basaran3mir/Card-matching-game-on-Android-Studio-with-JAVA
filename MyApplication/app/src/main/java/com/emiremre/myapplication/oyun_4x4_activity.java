...
public class oyun_4x4_activity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        Intent back_int = new Intent(oyun_4x4_activity.this, oyuna_basla_activity.class);
        this.finish();
        ...
        for (int i = 1; i < 45; i++) {
            ...
            mReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    ...
                    kartlar[id] = new kart(oyun_4x4_activity.this, id, kart_puani, kart_adi, kart_evi, onresim_id);
                    kartlar_es[id] = new kart(oyun_4x4_activity.this, id, kart_puani, kart_adi, kart_evi, onresim_id);
                }
                        ...
                        if(son_kart.kart_adi == ekran_kartlari.get(id).kart_adi) {
                            ...
                            h.postDelayed (new Runnable() {
                                ...
                                public void run() { //1 saniye bekle ve sifirlama islemlerini yap
                                    ...
                                    son_kart = new kart(oyun_4x4_activity.this,0,0,"0","0","0"); //Son karti sifirla
                                }
                            ...
                            if(counter == 1) {
                                ...
                                h.postDelayed (new Runnable() {
                                    ...
                                    public void run() { //1 saniye bekle ve sifirlama islemlerini yap
                                        ...
                                        son_kart.cevir();
                                        ekran_kartlari.get(id).cevir();
                                        son_kart = new kart(oyun_4x4_activity.this,0,0,"0","0","0");
        ...
        new CountDownTimer(45500, 1000) {
            ...
            public void onTick(long l) {
                ...
                if(kart_bulundu == 8) {
                    ...
                    Intent intnt = new Intent(oyun_4x4_activity.this, kazan_activity.class);
            ...
            @Override
            public void onFinish() {sayac.setText("Kalan zaman: 0");
                if(kart_bulundu != 8) {
                    cards_found_music.stop();
                    end_time_music.start();

                    Intent intnt = new Intent(oyun_4x4_activity.this, kaybet_activity.class);
                    intnt.putExtra("puan" , puan);
                    finish();
                    startActivity(intnt);
                }
